...
export default function Detail() {
  ...
  const arr = [
    ...
    { title: "Phần mềm", href: "/system/software" },
    { title: "Chi tiết", href: "/system/software/detail" },
  ];
     ...
     <Box style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      >
        ...
        >
          ...
          <Box style={{ flexGrow: 1, textAlign: "right" }}>
              <Button
                ...
                onClick={() => router.push("/system/software")}
              >
                Trở lại
              </Button>
            </Box>
        ...
        >
          ...
          >
            {data.map((item, index) => (
              <Group key={index} position="apart" style={{ marginBottom: 15 }}>
                <Text weight={500}>
                  {item.label}: {item.value}
                </Text>
